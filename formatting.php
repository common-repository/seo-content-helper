...
class sch_format {
	...
	function count_missing_keywords( $keywords, $content ) {
		if( ! empty( $keywords ) ) {
			foreach( $keywords as $keyword ) {
				if( $this->is_string_in_string( $keyword, $content ) ) {
				} else {
					$i++;
				}
			}
	...
	function count_found_keywords( $keywords, $content ) {
		if( ! empty( $keywords ) ) {
			foreach( $keywords as $keyword ) {
				if( $this->is_string_in_string( $keyword, $content ) ) {
					$i++;
	...
	function is_string_in_string( $needle, $haystack ) {
